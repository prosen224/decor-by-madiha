...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2022 at 08:02 AM
...
(1, 'Coder71', 'admin@coder71.com', '$2y$10$1ZKXvs2froxdCVNn5AgVwOhkxPF2ZRjFtLtrtATQ3/D1iCY.tBOe2', '', 'user-1.jpg', 1, NULL, '2021-04-28 12:44:21'),
(4, 'Mukul', 'info@britto-bd.com', '$2y$10$gCVdGXkGu9nK9R5Z1lXQO.wSTU.ha4prXLiFJRT6WjkbIr7A4Mmqm', '', 'user-4.jpg', 4, '2021-03-05 18:46:31', '2021-05-01 03:45:45');
...
INSERT INTO `clients` (`id`, `name`, `address`, `logo`, `url`, `status`, `sort_order`, `created_at`, `updated_at`) VALUES
(2, 'abc group', 'new elephpant road', 'clogo-2.jpg', 'www.facebook.com', 1, '1', '2021-05-04 23:06:56', '2021-05-05 04:17:58'),
(3, 'ky group', 'mirpur dhaka', 'clogo-3.png', NULL, 0, '1', '2021-05-04 23:32:03', '2021-05-05 04:22:15');
...
(1, 'logo.png', 'favicon.png', 'login_bg.png', 'info@britto-bd.com', '01713660885', 'Show', 'Hide', 'Hide', 'Hide', 5, 'a7a9ac', 'Important Links', 'Useful Links', 'Contact Information', 'Social Media', '1582 Progress, Mora, MN, 55051', 'contact@yourwebsite.com', '320-225-5131', 'Copyright 2021. Your Company Name. All Rights Reserved.', 'preloader.gif', 'Show', 'Show', 'UA-84213520-6', 'Hide', '<script type=\"text/javascript\">\r\n    var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();\r\n    (function(){\r\n        var s1=document.createElement(\"script\"),s0=document.getElementsByTagName(\"script\")[0];\r\n        s1.async=true;\r\n        s1.src=\'https://embed.tawk.to/5a7c31ded7591465c7077c48/default\';\r\n        s1.charset=\'UTF-8\';\r\n        s1.setAttribute(\'crossorigin\',\'*\');\r\n        s0.parentNode.insertBefore(s1,s0);\r\n    })();\r\n</script>', 'Hide', 'Show', '6LfzGuEZAAAAADZrHN3QDdPLYfS3I6BaKmjWjryh', 'Hide', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, '2021-05-03 04:44:59');
...
(59, '2021_05_05_031715_create_clients_table', 35),
(60, '2021_05_05_081102_add_clients_info_table', 36),
(61, '2021_05_05_084255_create_page_clients_items_table', 37);
...
(1, 'Career', NULL, 'Hide', 'Career', 'Career', NULL, '2021-05-01 03:40:04');

-- --------------------------------------------------------

--
-- Table structure for table `page_clients_items`
--

CREATE TABLE `page_clients_items` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `detail` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `page_clients_items`
--

INSERT INTO `page_clients_items` (`id`, `name`, `detail`, `status`, `seo_title`, `seo_meta_description`, `created_at`, `updated_at`) VALUES
(1, 'Clients', NULL, 'Show', NULL, NULL, '2021-05-05 04:45:51', '2021-05-05 04:47:34');
...
CREATE TABLE `page_home_items` (
  ...
  `clients_status` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `clients_subtitle` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `clients_title` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `page_home_items` (`id`, `seo_title`, `seo_meta_description`, `why_choose_title`, `why_choose_subtitle`, `why_choose_status`, `special_title`, `special_subtitle`, `special_content`, `special_btn_text`, `special_btn_url`, `special_yt_video`, `special_bg`, `special_video_bg`, `special_status`, `service_title`, `service_subtitle`, `service_status`, `testimonial_title`, `testimonial_subtitle`, `testimonial_status`, `testimonial_bg`, `project_title`, `project_subtitle`, `project_status`, `team_member_title`, `team_member_subtitle`, `team_member_status`, `appointment_title`, `appointment_text`, `appointment_btn_text`, `appointment_btn_url`, `appointment_bg`, `appointment_status`, `latest_blog_title`, `latest_blog_subtitle`, `latest_blog_status`, `newsletter_title`, `newsletter_text`, `newsletter_bg`, `newsletter_status`, `clients_status`, `clients_subtitle`, `clients_title`, `created_at`, `updated_at`) VALUES
(1, 'Britto Communication', 'Britto Communication & Logistics Service', 'Why Choose Us', 'You should choose our construction firm for the following reasons', 'Show', 'Welcome to our website', 'How we run the consulting business', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne.\r\n\r\nDuo luptatum delicata evertitur ad. Usu te quaerendum definitiones, ne mundi volutpat duo, in dissentias temporibus pri. Duo ferri dicant definitionem te.', 'Read More', '#', 'mJT899QyRvI', 'special_bg.jpeg', 'special_video_bg.jpeg', 'Hide', 'Our Services', 'Our team always provides quality services to our valuable clients', 'Show', 'Testimonial', 'What our clients tell about us', 'Show', 'testimonial_bg.jpg', 'Our Projects', 'See all our completed successful projects here', 'Show', 'Team Members', 'See all our expert team members who are ready to help you always', 'Hide', 'Want to hire us for your business?', 'If you want to take our service to build your business, our expert team members are always here to help you to make you successful.', 'Make An Appointment', '#', 'appointment_bg.jpeg', 'Hide', 'Latest Blog', 'See all the latest blog about our activity from here', 'Hide', 'Newsletter', 'Be always connected with us to know exiting promotional offers and activities', 'newsletter_bg.jpg', 'Show', 'Show', 'Some of out clients information is here', 'Our Clients', NULL, '2022-01-23 00:08:56');
...
(1, 'Service', NULL, 'Show', NULL, NULL, NULL, '2021-05-05 03:08:06');
...
(1, 'Shop', NULL, 'Hide', 'Shop', 'Shop Page Meta Description', NULL, '2021-05-01 03:39:23');
...
(1, 'Team Member', NULL, 'Hide', 'Team Member', 'Team Member', NULL, '2021-05-01 03:39:56');
...
(1, 'Event', 'event-service', '<ul><li>Any Kind of Launching&nbsp; Event</li><li>Venue Management</li><li>Seminar Organize and Management</li><li>Road show</li><li>Activation Management</li><li>Fair Organize and management</li><li>Weeding Management</li><li>Logistic Management</li><li>Staffing<br></li></ul>', 'Any Kind of Launching  Event, Venue Management, Seminar Organize and Management, Road show, Activation Management, Fair Organize and management, Weeding Management, Logistic Management and\r\nStaffing', 'service-1.jpeg', 'Event service provider dhaka bangladesh', 'Any Kind of Launching  Event, Venue Management, Seminar Organize and Management, Road show, Activation Management, Fair Organize and management, Weeding Management, Logistic Management and\r\nStaffing', '2020-11-22 23:35:59', '2021-05-01 05:54:49'),
(2, 'Creative', 'creative', '<ul><li>Concept and Design</li><li>Branding and Theme Development</li><li>Design and Printing Production</li><li>Photography and Videography<br><br></li></ul>', 'Concept and Design, Branding and Theme Development, Design and Printing Production, Photography and Videography', 'service-2.jpeg', 'Creative service provider dhaka bangladesh', 'Concept and Design, Branding and Theme Development, Design and Printing Production, Photography and Videography', '2020-11-22 23:36:45', '2021-05-01 05:57:27'),
(3, 'Production', 'production', '<ul><li>Outdoor Advertising</li><li>Shop/Office profiling</li><li>Artist Management</li><li>Cock-and-bull story</li><li>Show Producing</li><li>Entertainment Production</li><li>Audio Visual Production</li><li>CG/RDC making<br><br></li></ul>', 'Outdoor Advertising, Shop/Office profiling, Artist Management, Cock-and-bull story, Show Producing, Entertainment Production, Audio Visual Production, CG/RDC making', 'service-3.jpeg', 'Production service provider dhaka banladesh', 'Outdoor Advertising, Shop/Office profiling, Artist Management, Cock-and-bull story, Show Producing, Entertainment Production, Audio Visual Production, CG/RDC making', '2020-11-22 23:37:17', '2021-05-01 06:00:16'),
(4, 'Corporate Gift Items', 'corporate-gift-items', '<ul><li><b>Wooden made product:</b><br>Key ring, business card holder, tissue box, pen holder and any other wooden made gift items.</li><li><b>Leather made product:</b><br>File, folder, money bag, key ring, b.card holder, travel bag, laptop bag etc.</li><li><b>Jute made product:</b><br>File, folder, shopping bag, lunch bag, water caring bag, pen holder etc.<br><br></li></ul>', 'Key ring, business card holder, tissue box, pen holder, file, folder, money bag, key ring, b.card holder, travel bag, laptop bag, shopping bag, lunch bag, water caring bag, pen holder etc', 'service-4.jpeg', 'Corporate gift items provider in dhaka bangladesh', 'Key ring, business card holder, tissue box, pen holder, file, folder, money bag, key ring, b.card holder, travel bag, laptop bag, shopping bag, lunch bag, water caring bag, pen holder etc', '2020-11-22 23:37:38', '2021-05-01 06:10:28'),
(5, 'Printing', 'printing', '<ul><li>Offset printing</li><li>Digital printing</li><li>Brochure printing</li><li>Leaflet/Flyer printing</li><li>Annual Report printing</li><li>Stationary printing</li><li>Banner/Festoon/Billboard printing<br><br></li></ul>', 'Offset printing, Digital printing, Brochure printing, Leaflet/Flyer printing, Annual Report printing, Stationary printing, Banner/Festoon/Billboard printing', 'service-5.jpeg', 'Printing service provider in dhaka bangladesh', 'Offset printing, Digital printing, Brochure printing, Leaflet/Flyer printing, Annual Report printing, Stationary printing, Banner/Festoon/Billboard printing', '2020-11-22 23:37:53', '2021-05-01 06:35:14');
...
(2, 'We are number one in creative business', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis.', 'Read More', '#', 'slider-2.jpg', '2020-11-19 22:21:45', '2021-05-01 12:06:22'),
(3, 'We work for your success in real', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis.', 'Read More', '#', 'slider-3.jpg', '2020-11-19 22:22:04', '2021-05-01 12:06:41'),
(4, 'Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis.', 'Read More', '#', 'slider-4.jpg', '2021-05-01 12:10:59', '2021-05-01 12:10:59');
...
(7, 'rrakhmit@gmail.com', '9678796ee3536cfbe979ab3846780996475f3f7f62970d5ace06b744c3bf4eaa', 0, NULL, NULL);
...
--
-- Indexes for table `page_clients_items`
--
ALTER TABLE `page_clients_items`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `page_clients_items`
--
ALTER TABLE `page_clients_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
