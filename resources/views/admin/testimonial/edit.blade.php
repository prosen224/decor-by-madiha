    ...
    <form action="{{ url('admin/testimonial/update/'.$testimonial->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="">Featured Comment *</label>
                    <select name="featured" class="form-control form-control-sm" aria-label=".form-select-sm example">
                        <option
                        <?php if ($testimonial->featured == 1){
                            echo "selected";
                        } 
                        ?> value="1">Yes</option>
                        <option <?php if ($testimonial->featured == 0){
                            echo "selected";
                        } 
                        ?> value="0">No</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <img src="{{ asset('public/uploads/'.$testimonial->photo) }}" alt="" class="w_200">
                    </div>
                </div>
                <div class="form-group">
