        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="icon" class="form-control" value="{{ $why_choose->icon }}" autofocus>
                    <div class="pt-3">
                        <a title="Font Awesome" target="_blank" href="https://fontawesome.com/search?m=free&s=solid">Choose icon from this link</a>
                    </div>
                </div>
                {{-- <div class="form-group">
