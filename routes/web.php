...
use App\Modules\Clients\Controller\Admin\ClientController;
use App\Http\Controllers\Front\PortfolioGalleryController;
...
Route::get('/portfolio/{name}', [PortfolioGalleryController::class, 'index'])->name('front.portfolio.gallery');
Route::get('/videos', [PortfolioGalleryController::class, 'video'])->name('front.video.gallery');
Route::get('/testimonials', [PortfolioGalleryController::class, 'testimonials'])->name('front.testimonials');
...
Route::group(['prefix' => 'admin/page'], function () {
    ...
    Route::get('/clients/edit', [ClientController::class, 'nedit'])->name('admin.page_clients.edit');
    Route::post('/clients/update', [ClientController::class, 'nupdate']);
...
Route::get('admin/service/update/{id}', [ServiceControllerForAdmin::class, 'update']);
