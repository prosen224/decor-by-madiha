...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.project.index')->with('success', 'Portfolio is added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $project->fill($data)->save();
        return redirect()->route('admin.project.index')->with('success', 'Portfolio is updated successfully!');
    }
    ...
    public function gallerystore(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Portfolio Photo is added successfully!');
    }
    ...
    public function gallerydelete($id)
    {
        ...
        return Redirect()->back()->with('success', 'Portfolio Photo is deleted successfully!');
    }
}
